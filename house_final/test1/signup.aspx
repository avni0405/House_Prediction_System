<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="test1.signup" %>
          ...
          <div class="col-md-8 mb-md-5">
            ...
            <form action="#" class="bg-light p-5 contact-form">
              <div class="form-group">
                <input type="text" class="form-control" name="t1" placeholder="Enter Username">
              </div>
                <div class="form-group">
                <input type="password" class="form-control" name="t2" placeholder="Enter Password">
              </div>
                <div class="form-group">
                <input type="text" class="form-control" name="t3" placeholder="Enter Email">
              </div>
                 <div class="form-group">
                    Add photo:<asp:FileUpload id="img1" runat="server" />
                </div>
                <div class="form-group">
                <input type="submit" value="Sign Up" id="click" runat="server" class="btn btn-primary py-3 px-5">
              </div>
